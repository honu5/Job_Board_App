...
export default function Landing(){
  ...
  return (
    <div style={{minHeight:'100vh',display:'flex',flexDirection:'column',background:'#ffffff'}}>
      <section style={{padding:'56px 24px 32px',background:'#ffffff',color:'#064e3b'}}>
        <div className="container" style={{display:'flex',alignItems:'center',gap:24,flexWrap:'wrap'}}>
          <div style={{flex:'1 1 360px'}}>
            <h1 style={{fontSize:48,margin:0,color:'#065f46'}}>Find work you love</h1>
            <p style={{color:'#065f46',opacity:0.9}}>Meera Jobs connects talented people with great companies. Apply in minutes and track your progress transparently.</p>
          ...
          <div style={{flex:'1 1 320px',background:'#ecfdf5',border:'1px solid #d1fae5',borderRadius:16,padding:24}}>
            <h3 style={{marginTop:0,color:'#047857'}}>Why Meera?</h3>
      ...
      <section style={{padding:'40px 24px',background:'#065f46',color:'#ecfdf5',flexGrow:1}}>
